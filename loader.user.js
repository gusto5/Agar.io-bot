...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            window.jQuery.get('https://raw.githubusercontent.com/gusto5/Agar.io-bot/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                var script1 = "https://cdn.rawgit.com/gusto5/Agar.io-bot/" + sha + "/launcher.user.js";
                console.log("Script: " + script1);
                window.jQuery("body").append('<script type="text/javascript" src="' + script1 + '"></script>');
                
            });
            window.jQuery.get('https://raw.githubusercontent.com/gusto5/Agar.io-bot/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                var latestVersion = data.replace(/(\r\n|\n|\r)/gm, "");
                latestVersion = latestVersion.substring(latestVersion.indexOf("// @version") + 11, latestVersion.indexOf("// @grant"));

                latestVersion = parseFloat(latestVersion + 0.0000);
                var script2 = "https://cdn.rawgit.com/gusto5/Agar.io-bot/" + sha + "/bot.user.js";
            ...
            window.jQuery.get('https://raw.githubusercontent.com/gusto5/Agar.io-bot/loader.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                var latestVersion = data.replace(/(\r\n|\n|\r)/gm, "");
                latestVersion = latestVersion.substring(latestVersion.indexOf("// @version") + 11, latestVersion.indexOf("// @grant"));
                ...
                if (latestVersion > myVersion) {
                    update("aposLoader", "loader.user.js", "https://github.com/gusto5/Agar.io-bot/loader.user.js/");
                }
